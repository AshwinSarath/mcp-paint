...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(536, 88))
        time.sleep(3)
        ...
        paint = gw.getWindowsWithTitle('Paint')[0]
        paint.activate()

        pyautogui.moveTo(x1-3, y1-2, duration=1)
        pyautogui.click(x1-3, y1-2, duration=1)
        # pyautogui.moveTo(102, 102, duration=0.2)
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(528, 83))
        time.sleep(0.5)
        ...
        canvas.press_mouse_input(coords=(600-1, 440-1))
        canvas.click_input(coords=(600, 440))
        time.sleep(0.5)
        ...
        # canvas.click_input(coords=(600, 500))
